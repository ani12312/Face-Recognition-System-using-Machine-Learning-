...
def opencam():
    ...
    d=os.path.join("C:/Users/ANIRBAN MISRA/Downloads/originalimages_part1/ourdata",username1)
...
#show_frame(cv2frame)
            ...
            d1=os.path.join("C:/Users/ANIRBAN MISRA/Downloads/originalimages_part1/ourdata",username1,username1)
            filename=d1+str(i)+".jpg"
            i+=1
            cv2.imwrite(filename,cv2frame)
        ...
        cap.release()
        cv2.destroyAllWindows()
        path="C:/Users/ANIRBAN MISRA/Downloads/originalimages_part1/ourdata"
        arr1=os.listdir(path)
        for i in range(len(arr1)):
            arr1[i]=os.path.join(path,arr1[i])
        arr=[os.listdir(arr1[i]) for i in range(len(arr1))]
